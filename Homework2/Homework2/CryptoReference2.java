...
public class CryptoReference2
{
	...
	private static final String SIGNATURE_ALGORITHM     = "SHA256withECDSA";  //This part is for the signature
	...
	public void run(String keyname, String password) throws Exception
	{
		...
		if (signature.verify(sigBytes2)) {
			System.out.println("FAILURE: signature verification succeeded.");
		} else {
			System.out.println("SUCCESS: signature verification failed.");
		}
	}
